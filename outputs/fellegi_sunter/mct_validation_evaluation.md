...
Across the released evaluation scope, **45,290** canonical links auto-merge, **8,622** enter review, **8,569** remain separate after scoring, and **7,053** were blocked before scoring.
End-to-end auto-merge recall is **65.1336%** and auto-merge-plus-review recall is **77.5333%**.

## Safety result

Of **14,019** explicit hard negatives, **0** auto-merge, **449** enter review, **12,268** remain separate, and **1,302** never became candidates.
...
The MCT configuration and scored-pair file existed before labels were opened. This evaluator cannot alter production scores or decisions. Validation mode exposes development and validation metrics while the frozen test remains locked.
